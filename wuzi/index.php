...
switch ($state)
    {
        case nxq:
            header("location:http://tw.jnu.edu.cn/qyh/wuzi/wuzi.php?userid=$userid&accesstoken=$accesstoken&campus=south");
            break;
        case xbb:
            header("location:http://tw.jnu.edu.cn/qyh/wuzi/wuzi.php?userid=$userid&accesstoken=$accesstoken&campus=main");
            break;
        case all:
            header("location:http://tw.jnu.edu.cn/qyh/wuzi/applylist.php?userid=$userid&accesstoken=$accesstoken");
            break;
        default:
            header("location:http://tw.jnu.edu.cn/qyh/wuzi/detail.php?userid=$userid&accesstoken=$accesstoken&applyid=$state");
    }
